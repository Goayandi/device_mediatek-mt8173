...
DEVICE_PACKAGE_OVERLAYS += device/mediatek/mt8173/overlay
...
PRODUCT_COPY_FILES += device/mediatek/mt8173/factory_init.rc:root/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.fon.rc:root/init.fon.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.goldfish.rc:root/init.goldfish.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.modem.rc:root/init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.protect.rc:root/init.protect.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/meta_init.modem.rc:root/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/meta_init.rc:root/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/ueventd.goldfish.rc:root/ueventd.goldfish.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8173/auto_shutdown.sh:/$(TARGET_COPY_OUT_VENDOR)/bin/auto_shutdown.sh:mtk
PRODUCT_COPY_FILES += $(LOCAL_PATH)/vold.fstab:$(TARGET_COPY_OUT_VENDOR)/etc/vold.fstab:mtk
PRODUCT_COPY_FILES += $(LOCAL_PATH)/vold.fstab.nand:$(TARGET_COPY_OUT_VENDOR)/etc/vold.fstab.nand:mtk
PRODUCT_COPY_FILES += $(LOCAL_PATH)/vold.fstab.fat.nand:$(TARGET_COPY_OUT_VENDOR)/etc/vold.fstab.fat.nand:mtk
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab:root/fstab
PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.nand:root/fstab.nand
PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.fat.nand:root/fstab.fat.nand
...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/shutdownalertdialog.sh:$(TARGET_COPY_OUT_VENDOR)/bin/shutdownalertdialog.sh:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_codecs.xml:system/etc/media_codecs.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_codecs_mediatek_audio.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_profiles.xml:system/etc/media_profiles.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_profiles.xml:system/etc/permissions/media_profiles.xml
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_codecs_performance.xml:system/etc/media_codecs_performance.xml:mtk
PRODUCT_PACKAGES += audio.primary.mt8173
...
PRODUCT_PACKAGES += sensors.mt8173
PRODUCT_PACKAGES += libhwm
PRODUCT_PACKAGES += lights.mt8173
...
PRODUCT_PACKAGES += camera.mt8173
...
PRODUCT_PACKAGES += gralloc.mt8173
PRODUCT_PACKAGES += hwcomposer.mt8173
...
PRODUCT_PACKAGES += libmnlp_mt8173
...
RODUCT_PACKAGES += dnsmasq
RODUCT_PACKAGES += netd
RODUCT_PACKAGES += ndc
RODUCT_PACKAGES += libiprouteutil
RODUCT_PACKAGES += libnetlink
PRODUCT_PACKAGES += tc
PRODUCT_PACKAGES += libext2_profile
RODUCT_PACKAGES += e2fsck
...
PRODUCT_PACKAGES += memtrack.mt8173
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
  ifeq ($(MTK_PLATFORM),$(filter $(MTK_PLATFORM),MT8173))
    PRODUCT_PACKAGES += gralloc.mt8173.img
...
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.mt8173.rc:root/init.mt8173.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/factory_init.rc:root/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.modem.rc:root/init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/ueventd.mt8173.rc:root/ueventd.mt8173.rc

ifeq ($(strip $(MTK_C2K_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.c2k.rc:root/init.c2k.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/meta_init.c2k.rc:root/meta_init.c2k.rc
endif
...
PRODUCT_COPY_FILES += device/mediatek/mt8173/meta_init.modem.rc:root/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/meta_init.rc:root/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.mt8173.usb.rc:root/init.mt8173.usb.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/init.recovery.mt8173.rc:root/init.recovery.mt8173.rc
PRODUCT_COPY_FILES += device/mediatek/mt8173/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg:mtk
ifeq ($(strip $(MTK_EMMC_SUPPORT)), yes)
  ifeq ($(strip $(MTK_CIP_SUPPORT)), yes)
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt8173.wwop:root/fstab.mt8173
  else
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt8173:root/fstab.mt8173
  endif
else
PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt8173.nand:root/fstab.mt8173
endif
PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.off.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.off.conf:mtk
PRODUCT_COPY_FILES += $(LOCAL_PATH)/partition_permission.sh:$(TARGET_COPY_OUT_VENDOR)/etc/partition_permission.sh:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_codecs.xml:system/etc/media_codecs.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_codecs.xml:system/etc/permissions/media_codecs.xml

ifeq ($(strip $(MTK_WVDRM_L1_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt8173/mtk_omx_core_wvl1.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_codecs_mediatek_video_wvl1.xml:system/etc/media_codecs_mediatek_video.xml:mtk
else
PRODUCT_COPY_FILES += device/mediatek/mt8173/mtk_omx_core.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
PRODUCT_COPY_FILES += device/mediatek/mt8173/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml:mtk
endif
...
ifeq ($(strip $(TRUSTONIC_TEE_SUPPORT)), yes)
  PRODUCT_PACKAGES += keystore.mt8173
  PRODUCT_COPY_FILES += device/mediatek/mt8173/init.trustonic.rc:root/init.trustonic.rc
endif
...
#inherit prebuilt
$(call inherit-product-if-exists, vendor/mediatek/mt8173/device-vendor.mk)
...
PRODUCT_PACKAGES += keystore.mt8173
PRODUCT_PACKAGES += gatekeeper.mt8173
endif
